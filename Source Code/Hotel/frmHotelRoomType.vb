...
Public Class frmHotelRoomType
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        ...
        If XtraMessageBox.Show("Are you sure you want to continue?", compname, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
            If mode.Text = "edit" Then
                com.CommandText = "update tblhotelroomtype set hotelcif='" & hotelcif.Text & "',SortOrder='" & txtSort.EditValue & "', shortcode='" & txtShortname.Text & "', Description='" & rchar(UCase(txtDescription.Text)) & "',chargepernight=" & radChargeMode.EditValue & ", maxpax='" & Val(txtMaxPax.EditValue) & "' where code='" & code.Text & "'" : com.ExecuteNonQuery()
            Else
                com.CommandText = "insert into tblhotelroomtype set hotelcif='" & hotelcif.Text & "',SortOrder='" & txtSort.EditValue & "', shortcode='" & txtShortname.Text & "', code='" & code.Text & "', Description='" & rchar(UCase(txtDescription.Text)) & "',chargepernight=" & radChargeMode.EditValue & ", maxpax='" & Val(txtMaxPax.EditValue) & "'" : com.ExecuteNonQuery()
            End If
