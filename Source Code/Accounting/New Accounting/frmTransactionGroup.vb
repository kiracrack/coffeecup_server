...
Public Class frmTransactionGroup
    ...
    Public Sub filter()
        LoadXgrid("Select id, Description from tblgltransactiongroup order by Description", "tblgltransactiongroup", Em, GridView1, Me)
    ...
    Private Sub cmdaction_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If mode.Text = "edit" Then
            com.CommandText = "UPDATE tblgltransactiongroup set description='" & rchar(txtdescription.Text) & "' where id='" & groupid.Text & "'" : com.ExecuteNonQuery()
        Else
            com.CommandText = "insert into tblgltransactiongroup set description='" & rchar(txtdescription.Text) & "'" : com.ExecuteNonQuery()
        End If
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        If XtraMessageBox.Show("Are you sure you want to Continue? there's is no undo function once the code is deleted? ", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = vbYes Then
            com.CommandText = "delete from tblgltransactiongroup where id='" & GridView1.GetFocusedRowCellValue("id").ToString & "'" : com.ExecuteNonQuery()
            filter()
