...
Partial Class frmAPPOSelect
    ...
    Private Sub InitializeComponent()
        ...
        Me.cmdOk.TabIndex = 7
        Me.cmdOk.Text = "Confirm add checked item to Payable"
        '
        'gridmenustrip
        '
        ...
        Me.ckAp.Checked = True
        Me.ckAp.CheckState = System.Windows.Forms.CheckState.Checked
