...
Public Class frmProductTemplate3
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSaveParticular.Click
        ...
        UpdateProductTemplate3(mode.Text, productid.Text, txtBarcode.Text, catid.Text, rchar(txtitem.Text), rchar(txtPartNumber.Text), txtUnit.Text, ckEnableSell.CheckState, ckVatEnable.CheckState, ckNonInventory.CheckState, ckMenuMakerInventory.CheckState, ckMenuMakerServices.CheckState, Val(CC(txtPurchasedPrice.Text)), Val(CC(txtSellingRate.Text)), Val(CC(txtSellingPrice.Text)), radSaleMode.EditValue, ckInputDiscount.CheckState)
