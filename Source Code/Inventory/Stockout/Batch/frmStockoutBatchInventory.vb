...
Public Class frmStockoutBatchInventory
    ...
    Private Sub frmStockoutBatchInventory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ShowStockoutQuan()
        If CheckSelectedRow("Product Name", inventoryGrid) = True Then
            If frmStockoutBatchQuantity.Visible = True Then
                frmStockoutBatchQuantity.stockid.Text = inventoryGrid.GetFocusedRowCellValue("Stock No.").ToString
                frmStockoutBatchQuantity.Focus()
            Else
                frmStockoutBatchQuantity.stockid.Text = inventoryGrid.GetFocusedRowCellValue("Stock No.").ToString
                frmStockoutBatchQuantity.Show(Me)
            End If
        End If
    End Sub
