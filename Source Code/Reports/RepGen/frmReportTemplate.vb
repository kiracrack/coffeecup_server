...
Public Class frmReportTemplate
    ...
    Private Sub ExportTemplateToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExportTemplateToolStripMenuItem.Click
        ...
        If saveFileDialog1.ShowDialog() = DialogResult.OK Then
            ...
            While rst.Read
                detailReportTitle += "insert into tblreporttemplate set rptid='" & rst("rptid").ToString & "', rptname='" & rchar(rst("rptname").ToString) & "', rptquery='" & rchar(rst("rptquery").ToString) & "', status='" & rst("status").ToString & "', datequery=" & rst("datequery") & ", requestby='" & rst("requestby").ToString & "';"
            End While
            rst.Close()
