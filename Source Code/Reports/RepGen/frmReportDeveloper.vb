...
Public Class frmReportDeveloper
    ...
    Private Sub mode_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mode.EditValueChanged
        ...
        com.CommandText = "select *,(select description from tblreporttemplatetype where code = tblreporttemplate.reporttype) as 'report_type' from tblreporttemplate where rptid='" & id.Text & "'"
        rst = com.ExecuteReader
        While rst.Read
            txtReportTitle.Text = rst("rptname").ToString
            reportype.Text = rst("reporttype").ToString
            txtReportType.Text = rst("report_type").ToString
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        ...
        End If
        If mode.Text <> "edit" Then
            com.CommandText = "insert into tblreporttemplate set reporttype='" & reportype.Text & "',rptid='" & id.Text & "', rptname='" & rchar(txtReportTitle.Text) & "', rptquery='" & EncryptTripleDES(remSqlScript(txtReportQuery.Text.Replace(";", ""))) & "',datequery='" & CheckEdit1.CheckState & "',requestby='" & rchar(txtRequestBy.Text) & "'" : com.ExecuteNonQuery()
            com.CommandText = "update tblreportconfig set status=0 where rptid='" & id.Text & "'" : com.ExecuteNonQuery()
        Else
            com.CommandText = "update tblreporttemplate set reporttype='" & reportype.Text & "',rptname='" & rchar(txtReportTitle.Text) & "', rptquery='" & EncryptTripleDES(remSqlScript(txtReportQuery.Text.Replace(";", ""))) & "',datequery='" & CheckEdit1.CheckState & "',requestby='" & rchar(txtRequestBy.Text) & "' where rptid='" & id.Text & "'" : com.ExecuteNonQuery()
            com.CommandText = "update tblreportconfig set status=0 where rptid='" & id.Text & "'" : com.ExecuteNonQuery()
        End If
        ClearReports()
        ClearColumn()
    ...
    Private Sub SetGroupSummaryToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SetGroupSummaryToolStripMenuItem.Click
        Dim strSelected As String = ""
        For I = 0 To GridView1.SelectedRowsCount - 1
            strSelected = strSelected + GridView1.GetRowCellValue(GridView1.GetSelectedRows(I), "Column Name").ToString & ","
        Next
        strSelected = strSelected.Remove(strSelected.Length - 1, 1)
        txtGroupSummary.Text = strSelected
    End Sub

    Private Sub BarButtonItem6_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem6.ItemClick
        frmReportType.ShowDialog(Me)
    End Sub

    Private Sub BarButtonItem7_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem7.ItemClick
        frmReportFilters.Show(Me)
    End Sub
End Class