...
Public Class frmReportType
    ...
    End Sub
    Public Sub LoadData()
        LoadXgrid("select Code, Description from tblreporttemplatetype order by code asc", "tblreporttemplatetype", Em, Gridview1, Me)
    ...
    Public Sub LoadDetails(ByVal id As String)
        ...
        com.CommandText = "select * from tblreporttemplatetype where code='" & id & "'" : rst = com.ExecuteReader
        While rst.Read
    ...
    Private Sub submitData()
        ...
        If mode.Text = "edit" Then
            com.CommandText = "update tblreporttemplatetype set description='" & rchar(txtDescription.Text) & "'  where code='" & code.Text & "'" : com.ExecuteNonQuery()
        Else
            com.CommandText = "insert into tblreporttemplatetype set description='" & rchar(txtDescription.Text) & "' " : com.ExecuteNonQuery()
        End If
    ...
    Private Sub DeleteSelectedToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteSelectedToolStripMenuItem.Click
        If XtraMessageBox.Show("Are you sure you want to continue? ", compname, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
            com.CommandText = "DELETE FROM tblreporttemplatetype where code='" & Gridview1.GetFocusedRowCellValue("Code").ToString & "'" : com.ExecuteNonQuery()
            LoadData()
        End If
    End Sub
End Class